...
$sql = mysqli_query($koneksi, "select * from tbl_kelahiran tk INNER JOIN tbl_penduduk tp ON tk.nik = tp.nik where tanggal_lapor between '" . $tgl_awal . "' and '" . $tgl_akhir . "' ORDER BY tanggal_lapor asc");
            ...
            <center>
                <body>
                    <div class="container">
                        ...
                        <a href="../../dashboard.php?module=kelahiran" class="btn">Close</a>
                    </div>
                </body>
            </center>
        </div>
