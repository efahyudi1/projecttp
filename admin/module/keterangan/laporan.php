...
$sql = mysqli_query($koneksi, "select * from tbl_keterangan tk INNER JOIN tbl_penduduk tp ON tk.nik = tp.nik where tanggal_lapor between '" . $tgl_awal . "' and '" . $tgl_akhir . "' ORDER BY tanggal_lapor asc");
            ...
            <center>
                ...
                <body>
                    <div class="container">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $data['keterangan_lain'];?></td>
                                </tr>
                            </tbody>
                            <?php }
                        } else {
                        ...
                        <a href="../../dashboard.php?module=keterangan" class="btn">Close</a>
                    </div>
                </body>
            </center>
        </div>
