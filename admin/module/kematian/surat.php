...
$QueryTampil = mysqli_query($koneksi, "SELECT * FROM tbl_kematian tk INNER JOIN tbl_penduduk tp ON tp.nik = tk.nik INNER JOIN tbl_admin ta ON tk.id_admin = ta.id_admin WHERE id_kematian = '$id_kematian'");
...
$sebab = $row['sebab'];
$alamat_kematian = $row['alamat_kematian'];
...
<body>
        ...
        <div class="surat_tampil-print">
            ...
            <div id="nomer_surat">
                <div style="text-transform:uppercase;text-decoration:underline;font-weight:bolder">SURAT KETERANGAN
                    KEMATIAN</div>
                <div>Nomer : <?php echo $id_kematian?>/<?php echo $tanggal_lapor?></div>
            </div>
            ...
            <div id="par_isi"><span class="masuk_alinea">&nbsp;</span>Memang benar yang bersangkutan diatas warga Desa Blondo, Kecamatan Mungkid, Kabupaten Magelang telah meninggal dunia pada waktu :</div>
        
            <div id="content_surat">
                <div>
                    <label class="l_form">Tanggal</label>
                    <span class='titik'>:</span>
                    <span class='s_kanan'><?php echo $tanggal_kematian?></span>
                </div>
                <div>
                    <label class="l_form">Disebabkan karena</label>
                    <span class='titik'>:</span>
                    <span class='s_kanan'><?php echo $sebab?></span>
                </div>
                <div>
                    <label class="l_form">Di</label>
                    <span class='titik'>:</span>
                    <span class='s_kanan'><?php echo $alamat_kematian?></span>
                </div>
            </div>
            

            <div id="par_penutup"><span class="masuk_alinea">&nbsp;</span>Demikian Surat Keterangan Kematian ini kami buat dengan sebenarnya agar
    ...
    <div id="nomer_surat">
        ...
        <a href="../../dashboard.php?module=kematian"><button class="btn">Close</button></a>
        </center>
    </div>
</body>
