...
for($i = 1; $i < 13; $i++) {
$sql = mysqli_query($koneksi, "SELECT count(id_pindah) AS hasil FROM `tbl_pindah` WHERE MONTH(tanggal_lapor) = '$i'");
        ...
        <div class="card">
                    <div class="card-body">
                        <div class="container">
                            ...
                            <canvas id="pindah"></canvas>
                        </div>
                        <script>
                            var ctx = document.getElementById("pindah");
                            var pindah = new Chart(ctx, {
                                type: 'bar',
                                data: {
