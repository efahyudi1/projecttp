        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="login_action.php" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control" name="tanggal_lahir" tabindex="2" required>
                    <div class="invalid-feedback">
