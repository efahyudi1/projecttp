<main>
    ...
    <div class="our-services section-pad-t30">
        <div class="container">
            ...
            <form action="pages/pelayanansurat/keterangan/aksi_simpan.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-10">
                    <input type="text" name="keperluan" placeholder="Keperluan"
                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Keperluan'" required
                        class="single-input">
                </div>
                <div class="mt-10">
                    <input type="text" name="keterangan_lain" placeholder="Keterangan Lain" onfocus="this.placeholder = ''"
                        onblur="this.placeholder = 'Keterangan Lain'" required class="single-input">
                </div>
                <div class="input-group-icon mt-10">
                    <div class="icon"><i class="fas fa-venus-mars" aria-hidden="true"></i></div>
                    <div class="form-select" id="default-select">
