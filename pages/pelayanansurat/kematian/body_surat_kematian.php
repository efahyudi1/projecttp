<main>
    ...
    <div class="our-services section-pad-t30">
        <div class="container">
            ...
            <form action="pages/pelayanansurat/kematian/aksi_simpan.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-10">
                    <input type="date" name="tanggal_kematian" placeholder="Tanggal Kematian"
                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Tanggal Kematian'" required
                        class="single-input">
                </div>
                <div class="mt-10">
                    <input type="text" name="sebab" placeholder="Sebab Kematian" onfocus="this.placeholder = ''"
                        onblur="this.placeholder = 'Sebab Kematian'" required class="single-input">
                </div>
                <div class="input-group-icon mt-10">
                    <div class="icon"><i class="fas fa-map-marker-alt" aria-hidden="true"></i></div>
                    <input type="text" name="alamat_kematian" placeholder="Alamat Meninggal"
                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Alamat Meninggal'" required
                        class="single-input">
                </div>
